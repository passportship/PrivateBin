...
?>
		...
		<script type="text/javascript" data-cfasync="false" src="js/privatebin.js?<?php echo rawurlencode($VERSION); ?>" integrity="sha512-Jkc5T0aSrcnlX6MFOTaGvgrzIiatEim2O7yJE8CYjVh7jQlDRdNKa30e2oVgsRfTfo+zyWqt+yl0RZLlV2M1lA==" crossorigin="anonymous"></script>
		<!-- icon -->
...
?>
					<li>
						<div id="password" class="navbar-form hidden">
							<input type="password" id="passwordinput" placeholder="<?php echo I18n::_('Password (required)'); ?>" class="form-control" size="23" />
						</div>
					</li>
<?php
endif;

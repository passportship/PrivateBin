		...
		<section>
			<article>
				...
				<div id="toolbar">
					...
					<button id="sendbutton" class="hidden"><img src="img/icon_send.png" width="18" height="15" alt="" /><?php echo I18n::_('Get link to share'); ?></button>
...
?> />
						<label for="burnafterreading"><?php echo I18n::_('Can only be viewed one time'); ?></label>
					</div>
<?php
if ($DISCUSSION):
?>
